                                ...
                                <div className="collaborative card mt-lg-0 " style={{maxWidth: '37.5em'}}>
                                    <div className="card-body">
                                        ...
                                        <p className="card-text my-3 font-monospace">
                                                ...
                                                Some methods used include <a
                                                href="https://en.wikipedia.org/wiki/Convolutional_neural_network"
                                                className="link">CNNs</a>, <a
                                                href="https://en.wikipedia.org/wiki/XGBoost" className="link">XGBoost</a>,
                                        ...
                                        <div className="row-cols-md-3 my-4 gx-5">
                                            <button type="button"
                                                onClick={
                                                    () =>
                                                        window.open('https://gist.github.com/mikster36/018e111a1230f175dde97b686f6b52f1',
                                                            '_blank')}
