        ...
        <>
            ...
            <section id="About Me" className="bg-white pb-5 py-3 px-4 p-lg-5 text-left">
                <div id="scroll-child" className="container">
                    <div
                        className="row justify-content-between mb-lg-5"
                                ...
                                <div className="mt-4 row justify-content-center">
                                    <ul className="header text-center list-unstyled">
                                        ...
                                        <li className="mt-3 h4 font-monospace">
                                            <a
                                                href="mailto: michaelrortega@pm.me"
                                                className="link-dark"
                                            >
                                        ...
                                        <li className="h4 font-monospace">
                                            <div className="mt-4 row justify-content-center">
                                                <div className="col-auto">
                                                    <a
                                                        href="https://twitter.com/downbadbot"
                                                        className="link-dark"
                                                    >
                                                        <i
                                                            className="bi bi-twitter enlarged"
                                                            role="link"
                                                            aria-label="Twitter"
                                                        ></i>
                                                    </a>
                                                ...
                                                <div className="col-auto">
                                                    <a
                                                        href="https://github.com/mikster36"
                                                        className="link-dark"
                                                    >
                                                        <i
                                                            className="bi bi-github enlarged"
                                                            role="link"
                                                            aria-label="GitHub"
                                                        ></i>
                                                    </a>
                                                ...
                                                <div className="col-auto">
                                                    <a
                                                        href="https://www.linkedin.com/in/michaelrortega45/"
                                                        className="link-dark"
                                                    >
                                                        <i
                                                            className="bi bi-linkedin enlarged"
                                                            role="link"
                                                            aria-label="LinkedIn"
                                                        ></i>
                                                    </a>
                        ...
                        <div className="col-lg-7">
                            ...
                            <div className="mt-3">
                                <p id="bio" className="text-body font-monospace">
                                    I'm Michael, an aspiring machine learning engineer/researcher
                                    studying Computer science. I plan to pursue a PhD, focused on
                                    research in Machine Learning algorithms and methods. I'm still
                                    exploring literature to develop my specific research interests.
                                    <br />
                                    <br />I care about collaborating, learning, and finding
                                    solutions to even the smallest things. In my free time, I enjoy
                                    deejaying and producing{' '}
                                    <a href="https://mikster36.bandcamp.com/" className="link">
                                        electronic music
                                    </a>
                                    , skateboarding, playing video games (Overwatch, Zelda, & SSBU),
                                    and baking (bread, pizza, & sweets). At school, I run an EDM
                                    specialty show called{' '}
                                    <Link className="link" to={'/two-step-authentication'}>
                                        Two Step Authentication
                                    </Link>{' '}
                                    and another called{' '}
                                    <a
                                        href="https://www.wrek.org/shows/electronic-soundsystem/"
                                        className="link"
                                    >
                                    ...
                                    <a
                                        href="https://www.instagram.com/gtskateboardingclub/"
                                        className="link"
                                    >
                            ...
                            <div className="row row-1 mt-5 justify-content-center">
                                <div className="col-sm-8">
                                    <h1 className="header display-6 fw-bold text-center text-md-start">
                                        Education
                                    </h1>
                                ...
                                <div className="box col-sm">
                                    ...
                                    <ul className="list-group-flush text-start ms-2 mt-1">
                                        <li className="list-group-item-light font-monospace">
